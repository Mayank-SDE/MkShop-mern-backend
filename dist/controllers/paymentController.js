...
export const createCoupon = async (request, response, next) => {
    try {
...
export const applyDiscount = async (request, response, next) => {
    try {
...
export const deleteCoupon = async (request, response, next) => {
    try {
